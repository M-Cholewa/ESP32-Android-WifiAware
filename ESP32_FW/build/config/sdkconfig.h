...
#define CONFIG_ESP_WIFI_NAN_SVC_NAME "test"
#define CONFIG_EXAMPLE_NAN_PUBLISH_UNSOLICITED 1
#define CONFIG_ESP_WIFI_NAN_MATCHING_FILTER ""
#define CONFIG_ESP_WIFI_NAN_SERVICE_MESSAGE "Welcome"
